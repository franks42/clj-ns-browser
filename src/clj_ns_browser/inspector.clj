...
;; Note: This file is identical to clojure.inspector, except that the
;; patch for ticket CLJ-783 has been applied to (so the inspector
;; works on sets and sequences), plus a few other minor enhancements.
...
(defn inspect-tree 
  ...
  {:added "1.0"}
  [data & title]
  (doto (JFrame. (or (first title) "Clojure Inspector"))
